...
namespace conditionals___william_garcia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Asks user to enter a greade and assigns it to a char variable, grade
